...
const generateTabShapePath: GenerateTabShapePath = (
    ...
    const adjustedWidth = SCREEN_WIDTH / NUM_TAB;
...
const usePath = () =>{
    ...
    const containerPath = useMemo(()=>{
        return `M0,0L${SCREEN_WIDTH},0L${SCREEN_WIDTH},0L${SCREEN_WIDTH},${tHeight}L0${adjustedHeight}`
    },[tHeight])

    const curvedPaths = useMemo(()=>{
        return Array.from({length: NUM_TAB}, (_, index)=>{
