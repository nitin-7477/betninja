  ...
  return (
    ...
    >
      <View style={{ flexDirection: 'row', alignItems: 'center', marginVertical: 10, paddingHorizontal: 10 }}><TouchableOpacity
        ...
        <Text style={{ fontWeight: '900', marginBottom: 1, fontSize: 20, color: Colors.purple, marginLeft: 50 }}>Confidential Agreement</Text></View>
      ...
      <View style={{ flex: 1, width: SCREEN_WIDTH * 0.8, alignSelf: 'center' }}>
        <Text>Confidentiality Agreement
          ...
          Account means a unique account created for You to access our Service or parts of our Service.Website refers to BigMumbai.com, accessible from BigMumbai.com
          Service refers to the Website.
          Country refers to: Dhaka, Bangladeshi
          Service Provider means any natural or legal person who processes the data on behalf of the Company. It refers to third-party companies or individuals employed by the Company to facilitate the Service, to provide the Service on behalf of the Company, to perform services related to the Service or to assist the Company in analyzing how the Service is used.
          Third-party Social Media Service refers to any website or any social network website through which a User can log in or create an account to use the Service. Personal Data is any infonnation that relates to an identified or identifiable individual
          ...
          We may also collect information thunt Your browser sends whenever You visit our Service or when You access the Service by or through a mobile device.
          ...
          Cookies Policy / Notice Acceptance CookiesAdministered by: Us
          ...
          For the performance of a contract: the development. compliance and undertaking of the purchase contract for the products, items or services You have purchased or of any other contract with Us through the Service. To contact You: To contact You by email, telephone calls, SMS, or other equivalent forms of electronic communication, such as a mobile application's push notifications regarding updates or informative communications related to the functionalities, products or contracted services, including the security updates, when necessary or reasonable for their implementation.Civics, eng шe security upumes, when necessary or reasonable for their implementation. To provide you with news, special offers and general information about other goods, services and events which we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such information.
          ...
          can contact us:
          By visiting this page on our website:BigMumbai.com</Text>
      </View>
    </ScrollView>
  )
}
