...
const NewSmallModal = ({ isVisible, closeModal }) => {
    ...
    >
      ...
      <KeyboardAvoidingView style={{ justifyContent: 'flex-end', alignItems: 'center', flex: 1 }}>
        <View style={styles.diaLogViolet}>
          ...
          <View style={{ height: 25, width: 150, display: 'flex', justifyContent: 'center', backgroundColor: '#436b95', borderRadius: 10, marginVertical: 5, alignItems: 'center' }}>
            <Text style={{ color: 'white', textAlign: 'center' }}>Select Small</Text>
          </View>
          <View style={{ height: '25%', width: '97%', padding: 10, display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <View style={{ flexDirection: 'row' }}>
              ...
              <TextInput
                style={{ backgroundColor: '#436b95', color: 'white' }}
...
const styles = StyleSheet.create({
  ...
  diaLogViolet: {
    ...
    backgroundColor: '#add8e6', borderColor: 'black', borderWidth: 2
  },
});

export default NewSmallModal;
