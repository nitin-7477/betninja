...
const NewGreenModal = ({ isVisible, closeModal }) => {
    ...
    >
      ...
      <KeyboardAvoidingView style={{ justifyContent: 'flex-end', alignItems: 'center', flex: 1 }}>
        <View style={styles.diaLogViolet}>
          ...
          <View style={{ height: 25, width: 150, display: 'flex', justifyContent: 'center', backgroundColor: 'green', borderRadius: 10, marginVertical: 5, alignItems: 'center' }}>
            <Text style={{ color: 'white', textAlign: 'center' }}>Green</Text>
          </View>
