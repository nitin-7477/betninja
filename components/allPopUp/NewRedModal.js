    ...
    >
      ...
      <KeyboardAvoidingView style={{ justifyContent: 'flex-end', alignItems: 'center', flex: 1 }}>
        <View style={styles.diaLogViolet}>
          ...
          <View style={{ height: 25, width: 150, display: 'flex', justifyContent: 'center', backgroundColor: 'red', borderRadius: 10, marginVertical: 5, alignItems: 'center' }}>
